...
public class ActiveAccountsRVAdapterNew extends RecyclerView.Adapter<ActiveAccountsRVAdapterNew.ViewHolder>{
  ...
  public ActiveAccountsRVAdapterNew(List<GroupAccount> accountsList, int itemLayout) {
    this.accountsList = accountsList;
    this.itemLayout = itemLayout;
  }

  public ActiveAccountsRVAdapterNew(List<GroupAccount> accountsList, Context context) {
    this.accountsList = accountsList;
